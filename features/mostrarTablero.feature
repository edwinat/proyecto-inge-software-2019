Feature:
        ...
        #Si las posciones estan correctas muestra True
        Scenario:
        ...
        Scenario:       
        Given visito la pagina de simular con parametro "posicionActualX1=-2"
        Then el nombre mostraria "X1: -2"
        Then el nombre mostraria "estaFuera1: false"

        Scenario:       
        Given visito la pagina de simular con parametro "posicionActualY1=-2"
        Then el nombre mostraria "Y1: -2"
        Then el nombre mostraria "estaFuera1: false"
